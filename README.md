...
## ETL
Los datos fueron proporcionados en un dataset en formato Excel (fuente: ENACOM) con sheets que contenían la información discriminada por diferentes sub-temáticas. Luego de inspeccionarlas, decidí dejar de lado algunas paginas que no aportaban información relevante para el análisis, y conglomerar las de interés en un archivo con las variables significativas para su medición en cuanto a las diferentes tecnologías, velocidades y la penetración de la industria en los hogares y personas (medido por cant. de conexiones) y clasificado por provincias en años y trimestres; y en otro archivo lo referente a los ingresos, tambien por años y trimestres. 
...
## EDA
En este paso, se analizaron los dos datasets generados: una inspección inicial de la calidad ds los datos. el número de filas, columnas, se verificó la existencia de valores faltantes, duplicados. Hubo reconocimiento de la variables: cuantitativas(numéricas) y cualitativas(categóricas). De las primeras se obtuvo un informe de estadístivas descriptivas, separadas por temática para un análisis posterior mas claro y enfocado. 
Se realizó un analisis univariante de la variable categórica y de las numéricas, para luego comenzar a relacionar unas con otras (análisis bivariante), y un análisis multivariante con el objetivo de hallar patrones, relaciones y asociaciones entre las características. Cada gráfico, consulta o evaluación realizada en el notebook, tiene su correspondiente análisis.

## Conclusión General

En resumen, se destaca una desigualdad significativa en la adopción y calidad de las tecnologías de acceso a internet entre las diferentes regiones del país, con una clara necesidad de mejoras en infraestructura en las áreas menos desarrolladas para cerrar la brecha digital.
Existe una evolución positiva en la adopción de tecnologías de internet más avanzadas y en el aumento de las velocidades de conexión. Sin embargo, también sobresale la desigualdad regional en términos de acceso y calidad de internet. Las provincias con mayor inversión en infraestructura y adopción de tecnologías avanzadas, como la fibra óptica y el cablemodem, están mejor posicionadas para satisfacer la creciente demanda de servicios de internet de alta velocidad. Por otro lado, las provincias con menor inversión y dependencia de tecnologías más antiguas, como ADSL, enfrentan desafíos significativos para cerrar la brecha digital y mejorar la calidad del acceso a internet.
